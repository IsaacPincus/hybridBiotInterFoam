...
pathVelocity = './Aug29_High_conc/pillarsSolidsVelocity'
pathElastic = './Aug29_High_conc/pillarsSolidsElastic'
pathTransport = './Aug29_High_conc/scalarTransport'
imagePath = './Aug29_High_conc/ManyCylindersOld.png'
...
if show_plots:
    ...
    plt.imshow(yieldStress, cmap='viridis', aspect='auto')
    plt.colorbar(label='yield stress')
    plt.show()

if show_plots:
    plt.title('SigEq')
    plt.imshow(sigEq2D, cmap='viridis', aspect='auto')
    plt.colorbar(label='VM stress')
    plt.show()
...
U2DTemp = to_2d(np.linalg.norm(UfieldTemp, axis=1), image_cell_values)
...
if show_plots:
    plt.title('area to remove')
    plt.imshow((U2DTemp > 1e-5), cmap='viridis', aspect='auto')
    plt.colorbar(label='true or false')
    plt.show()

if show_plots:
    plt.title('velocity field')
    plt.imshow(U2DTemp, cmap='viridis', aspect='auto', norm='log')
